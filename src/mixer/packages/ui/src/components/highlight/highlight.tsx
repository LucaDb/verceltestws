...
import { usePrevious } from '@websolutespa/bom-mixer-hooks';
import React, { useMemo, useRef } from 'react';
import styled, { css } from 'styled-components';
import { ReactiveDomReact, isUnplacedRect } from '../dropdown/dropdown-layout';
...
const StyledHighlight = styled.div<{ position: HighlightPosition, activeOpacity: number }>`
  ...
  border-radius: 18px;
  opacity: 0;
  transition: all 0.2s cubic-bezier(0.73, 0.01, 0.24, 1);
